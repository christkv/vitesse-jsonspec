...
var Compiler = require('vitesse').CompilerV2,
  ClosureCompiler = require('vitesse').ClosureCompilerV2;
...
CompileState.prototype.buildASTSync = function(schema) {
  // console.log("##################################################### explode sync 0")
  // Explode the schema
  var schema = explodeSync(schema, clone(this.options));
  // console.log("##################################################### explode sync 1")
  // console.dir(schema)
  // Translate the schema
...
var explodeSync = function(schema, options) {
  // console.log("----------------------------------------------- explodeSync 0")
  var seenObjects = [];
  // Dereference the entire object
  extractReferences(schema, schema, seenObjects, [], options);  
  // console.log("----------------------------------------------- explodeSync 1")
  return schema;
}
